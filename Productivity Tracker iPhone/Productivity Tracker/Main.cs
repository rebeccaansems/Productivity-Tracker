...
namespace Productivity_Tracker
{
    public class Application
    {
...
#endif
        //General
        UIButton b_Summary, b_Main, b_Options;
        //Summary
        UITextView t_SummaryMost, t_SummaryLeast;
        //Main
        UIButton b_Awesome, b_Good, b_Mediocre, b_Poor, b_Terrible;
        //Options
        UIButton b_TimeMin, b_TimeMax, b_Clear, b_RemoveLastPoint;
        UITextView t_TimeMin, t_TimeMax;
        ...
        void CreateNotification()
        {
            ...
            notification.FireDate = NSDate.FromTimeIntervalSinceNow(60 * 60);//notification in one hour
            if (DateTime.Now.Hour + 1 > hourMax)//tomorrow morning
            {
                notification.FireDate = NSDate.FromTimeIntervalSinceNow(new DateTime(2010, 1, 2, hourMin, minuteMin, 0).Subtract(new DateTime(2010, 1, 1, hourMax, minuteMax, 0)).TotalSeconds);
            }
